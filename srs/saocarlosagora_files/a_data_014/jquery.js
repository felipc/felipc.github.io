...
{factory(jQuery);}}
(function($)
{var pluginName="tinycarousel",defaults={start:1,axis:"x",buttons:true,bullets:false,interval:true,intervalTime:7000,animation:true,animationTime:300,infinite:true};function Plugin($container,options)
